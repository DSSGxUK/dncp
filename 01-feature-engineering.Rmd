...
```{r fe-buyer-groupings-table, echo=FALSE}
patterns <- data.frame(
  police      = "policia",
...
knitr::kable(t(patterns), row.names = TRUE, col.names = c("String Pattern"))
```
...
```{r fe-context-groupings-table, echo=FALSE}
patterns <- data.frame(
